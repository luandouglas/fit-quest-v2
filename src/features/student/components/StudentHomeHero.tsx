    ...
    <FqCard className="fq-fitness-glow overflow-hidden border-border/80 bg-card/95">
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.18fr)_320px]">
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <FqText as="h1" className="fq-display text-[2.15rem] leading-[0.98] text-foreground md:text-[2.95rem]">
                Clareza para agir hoje. Progresso para voltar amanhã.
              </FqText>
              <FqText as="p" className="max-w-2xl text-sm leading-relaxed text-muted-foreground md:text-[0.95rem]">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="fq-soft-block px-4 py-4 shadow-[0_10px_24px_rgba(36,49,44,0.04)]">
              <FqText as="p" className="fq-subtle-label">
                Ritmo do dia
              </FqText>
              <FqText as="p" className="mt-2 text-[1.85rem] font-semibold tracking-tight text-foreground">
          ...
          <div className="space-y-3 rounded-[calc(var(--radius)+6px)] border border-border/75 bg-background/72 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]">
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
          ...
          />
          <div className="rounded-[calc(var(--radius)+6px)] border border-border/75 bg-background/72 p-4 shadow-[0_12px_28px_rgba(36,49,44,0.04)]">
            <FqText as="p" className="fq-subtle-label">
              Semana em resumo
            </FqText>
