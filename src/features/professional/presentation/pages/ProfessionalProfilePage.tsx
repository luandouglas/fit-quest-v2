  ...
  return (
    <FqPage className="min-h-full bg-transparent">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 py-2 md:py-4">
        <section className="rounded-2xl border border-border/70 fq-bg-radial-professional px-6 py-7 shadow-deep md:px-8 md:py-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-3">
              <span className="inline-flex w-fit items-center rounded-full border border-secondary/25 bg-secondary/10 px-3 py-1 text-xs font-semibold uppercase tracking-caps-wide text-secondary">
                {roleLabelMap[professionalRole]}
              </span>
              <div className="space-y-2">
                <FqText as="h1" variant="title" className="text-section-title text-foreground">
                  {user.name}
                </FqText>
        ...
        <div className="grid gap-6 lg:fq-grid-main-sidebar-35">
          <FqCard
          ...
          >
            <dl className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
                <dt className="text-xs font-semibold uppercase tracking-caps-wide text-muted-foreground">
                  Nome
                </dt>
